...
function change(){
        ...
        ulang:
		<title>Tools</title>
<h1>Reseller Tools AldyanVIP-Hack</h1>
<form action='' method='post'>
<p><label for='field1'><span>Reseller </span></label><input class='input-field' placeholder='Nomor' type='text' name='no'></p>
        ...
        gocar:
        echo "\n".color("yellow","!] Claim voc GOFOOD 50%");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
